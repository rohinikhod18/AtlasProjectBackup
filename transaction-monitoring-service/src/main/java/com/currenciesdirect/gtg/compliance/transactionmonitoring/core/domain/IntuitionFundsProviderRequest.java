...
@Getter
@Setter
public class IntuitionFundsProviderRequest implements Serializable {
	...
	@JsonProperty(value = "funds_in_state")
	private String fundsInState;

	@JsonProperty(value = "collection_bank_name")
	private String collectionBankName;

	@JsonProperty(value = "collection_bank_account_number")
	private String collectionBankAccountNumber;

	@JsonProperty(value = "collection_bank_account_name")
	private String collectionBankAccountName;
	
	@JsonProperty(value = "Transactional")
	private List<IntuitionFundsTransactional> transactional;
	
	@JsonProperty(value = "Debit_Card")
	private List<IntuitionFundsDebitCard> debitCard;
	
	@JsonProperty(value = "Device_and_IP")
	private List<IntuitionFundsDeviceAndIP> deviceAndIP;
	
	@JsonProperty(value = "Atlas_Flags")
	private List<IntuitionFundsAtlasFlags> atlasFlags;
	
	@JsonProperty(value = "Calculations")
	private List<IntuitionFundsCalculations> calculations;
