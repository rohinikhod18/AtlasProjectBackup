...
/**
 * The Class CustomCheckDeleteRequest.
 */
public class CustomCheckDeleteRequest implements IDomain{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CustomCheckDeleteRequest other = (CustomCheckDeleteRequest) obj;
	...
	public String toString() {
		return "CustomCheckDeleteRequest [occupation=" + occupation + ", sourceOfFund=" + sourceOfFund
