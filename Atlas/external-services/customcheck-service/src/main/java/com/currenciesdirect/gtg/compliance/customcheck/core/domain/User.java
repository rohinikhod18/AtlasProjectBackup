...
public class User implements java.io.Serializable {
	...
	public String toString() {
		return "User [title=" + title + ", firstName=" + firstName + ", lastName=" + lastName + ", preferredName="
				+ preferredName + ", email=" + email + ", userId=" + userId + ", roleId=" + roleId + ", orgCode="
				+ orgCode + ", source=" + source + ", role=" + role + ", roleFuctionList=" + roleFuctionList + "]";
	}
