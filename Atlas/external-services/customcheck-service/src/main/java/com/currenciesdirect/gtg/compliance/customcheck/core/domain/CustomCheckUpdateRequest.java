...
/**
 * The Class CustomCheckUpdateRequest.
 */
public class CustomCheckUpdateRequest  implements IDomain{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CustomCheckUpdateRequest other = (CustomCheckUpdateRequest) obj;
	...
	public String toString() {
		return "CustomCheckUpdateRequest [occupation=" + occupation + ", sourceOfFund=" + sourceOfFund
