...
public class ResteasyClientHandler {
	...
	/** The stale monitor. */
	private static PaymentRefIdleConnectionMonitorThread fStaleMonitor = null;
	...
	private ResteasyClientHandler() {
		...
		fStaleMonitor = new PaymentRefIdleConnectionMonitorThread(cm);
...
class PaymentRefIdleConnectionMonitorThread extends Thread {
	private static final Logger LOG = LoggerFactory.getLogger(PaymentRefIdleConnectionMonitorThread.class);
	private final PoolingClientConnectionManager fConnMgr;
	private volatile boolean PaymentRefShutdown;

	public PaymentRefIdleConnectionMonitorThread(PoolingClientConnectionManager connMgr) {
		super();
