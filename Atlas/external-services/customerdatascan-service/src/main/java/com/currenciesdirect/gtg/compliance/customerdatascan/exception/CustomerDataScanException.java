 ...
 */
public class CustomerDataScanException extends Exception {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;
	
	/** The customer data scan errors. */
	private final CustomerDataScanErrors customerDataScanErrors;
	 ...
	 */
	public CustomerDataScanException(CustomerDataScanErrors customerDataScanErrors, Throwable orgException){
	 ...
	 * @param customerDataScanErrors the customer data scan errors
	 */
	public CustomerDataScanException(CustomerDataScanErrors customerDataScanErrors){
	 ...
	 */
	public CustomerDataScanException(CustomerDataScanErrors customerDataScanErrors,String description){
	 ...
	 */
	public CustomerDataScanErrors getCustomerDataScanErrors() {
