...
public class RestServer implements AutoCloseable {
    ...
    private RestServer(int port,Object... objects) {
    	this.port = port;
        append(objects);
    }
     ...
     *
     * @param objects
     * @return running instance of {@link RestServer}
     * @throws IOException
     */
    public static RestServer create(int port,Object... objects) throws IOException {

        return create(null, port,objects);
    }
     ...
     * @throws IOException
     */
    public static RestServer create(SecurityDomain securityDomain, int port, Object... objects) throws IOException {
    	
        RestServer inMemoryRestServer = new RestServer(port,objects);
