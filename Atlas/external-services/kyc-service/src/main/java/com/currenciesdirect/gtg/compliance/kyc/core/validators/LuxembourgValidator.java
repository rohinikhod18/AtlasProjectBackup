...
/**
 * The Class LuxembourgValidator.
 *
 * @author manish
 */
public class LuxembourgValidator extends AbstractValidator implements Ivalidator {


	/* (non-Javadoc)
	 * @see com.currenciesdirect.gtg.compliance.kyc.core.validators.Ivalidator#validateKYCRequest(com.currenciesdirect.gtg.compliance.commons.domain.kyc.KYCContactRequest)
	 */
	@Override
