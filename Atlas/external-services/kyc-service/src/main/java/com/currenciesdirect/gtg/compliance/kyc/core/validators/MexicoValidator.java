...
/**
 * The Class MexicoValidator.
 *
 * @author manish
 */
public class MexicoValidator extends AbstractValidator implements Ivalidator {
	...
	public FieldValidator validateKYCRequest(KYCContactRequest request) throws KYCException {
		...
		return super.validateKYCRequestFnameLnameDobPostCode(request);
	}
}
