...
public class SwitzerlandValidatorTest {
	
	@InjectMocks
	SwitzerlandValidator switzerlandValidator;
	...
	public void testValidateKYCRequest() {
		...
		try {
			FieldValidator validator=switzerlandValidator.validateKYCRequest(request);
