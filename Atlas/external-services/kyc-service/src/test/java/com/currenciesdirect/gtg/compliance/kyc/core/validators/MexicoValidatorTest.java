...
public class MexicoValidatorTest {
	
	@InjectMocks
	MexicoValidator mexicoValidator;
	...
	public void testValidateKYCRequest() {
		...
		try {
			FieldValidator validator=mexicoValidator.validateKYCRequest(request);
	...
	public void testForValidateKYCRequest() {
		...
		FieldValidator validator1= new FieldValidator();
		validator1.addError("can not be blank", "last_name, dob");
		PersonalDetails personalDetails = new PersonalDetails();
		personalDetails.setForeName("Chadsley");
