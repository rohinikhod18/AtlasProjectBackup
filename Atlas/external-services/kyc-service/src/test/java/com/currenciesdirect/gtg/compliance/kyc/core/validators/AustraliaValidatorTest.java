...
public class AustraliaValidatorTest {

	@InjectMocks
	AustraliaValidator australiaValidator;
	...
	public KYCContactRequest kYCContactRequest() {
		KYCContactRequest kYCContactRequest = new KYCContactRequest();
		kYCContactRequest.setContactSFId("0030O000029F9O1QAK");
	...
	public void testValidateKYCRequest() {
		...
		try {
			validator=australiaValidator.validateKYCRequest(request);
	...
	public void testForValidateKYCRequest() {
		KYCContactRequest request = kYCContactRequest();
		FieldValidator validator;
		FieldValidator validator1 = new FieldValidator();
