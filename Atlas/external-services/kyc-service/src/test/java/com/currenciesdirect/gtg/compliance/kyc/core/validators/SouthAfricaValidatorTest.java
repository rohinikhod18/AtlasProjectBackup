...
public class SouthAfricaValidatorTest {

	@InjectMocks
	SouthAfricaValidator southAfricaValidator;
	...
	address.setAddress1("2204 Glencair");
	...
	public void testValidateKYCRequest() {
		...
		try {
			FieldValidator validator=southAfricaValidator.validateKYCRequest(request);
	...
	public void testForValidateKYCRequest() {
		...
		FieldValidator validator1= new FieldValidator();
		validator1.addError("can not be blank", "street");
