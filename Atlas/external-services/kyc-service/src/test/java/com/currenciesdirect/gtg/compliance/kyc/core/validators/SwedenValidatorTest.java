...
public class SwedenValidatorTest {

	@InjectMocks
	SwedenValidator swedenValidator;
	...
	public KYCContactRequest kYCContactRequestMocking() {
		...
		personalDetails.setTitle("personalInfo");
	...
	public void testValidateKYCRequest() {
		...
		try {
			FieldValidator validator = swedenValidator.validateKYCRequest(request);
	...
	public void testForValidateKYCRequest() {
		...
		FieldValidator validator1 = new FieldValidator();
		validator1.addError("can not be blank", "title, dob");
