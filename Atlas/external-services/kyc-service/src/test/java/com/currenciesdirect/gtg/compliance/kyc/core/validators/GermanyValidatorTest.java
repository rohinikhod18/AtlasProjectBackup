...
public class GermanyValidatorTest {

	@InjectMocks
	GermanyValidator germanyValidator;
	...
	public void testValidateKYCRequest() {
		...
		try {
			validator=germanyValidator.validateKYCRequest(request);
	...
	public void testForValidateKYCRequest() {
		...
		validator1.addError("can not be blank", "first_name, last_name");
		try {
			FieldValidator validator=germanyValidator.validateKYCRequest(request);
