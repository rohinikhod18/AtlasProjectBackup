...
public class LuxembourgValidatorTest {

	@InjectMocks
	LuxembourgValidator luxembourgValidator;
	...
	public void testValidateKYCRequest() {
		...
		try {
			FieldValidator validator=luxembourgValidator.validateKYCRequest(request);
	...
	public void testForValidateKYCRequest() {
		...
		FieldValidator validator1= new FieldValidator();
		validator1.addError("can not be blank", "dob");
		try {
			FieldValidator validator=luxembourgValidator.validateKYCRequest(request);
