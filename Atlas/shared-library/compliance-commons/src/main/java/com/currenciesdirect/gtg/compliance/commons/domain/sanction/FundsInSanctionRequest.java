...
/**
 * The Class FundsInSanctionRequest.
 *
 * @author manish
 */
public class FundsInSanctionRequest extends ServiceMessage implements Serializable{
	 ...
	 *
	 * @param contactrequests the new contactrequests
	 */
	 ...
	 *
	 * @param beneficiaryRequests the new beneficiary requests
	 */
	 ...
	 *
	 * @param bankRequests the new bank requests
	 */
	...
	public String toString() {
		return "FundsInSanctionRequest [orgCode=" + orgCode +  ", customerType="
				+ customerType + ", contactrequests=" + contactrequests + ", beneficiaryRequests=" + beneficiaryRequests
				+ ", bankRequests=" + bankRequests + ", sourceApplication=" + sourceApplication + "]";
	}
