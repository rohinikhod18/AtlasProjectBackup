...
/**
 * The Class FraugsterSignupRequest.
 *
 * @author manish
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class FraugsterSignupRequest extends ServiceMessage implements Serializable {
	...
	private List<FraugsterSignupContactRequest> contactRequests;
	 ...
	 */
	public List<FraugsterSignupContactRequest> getContactRequests() {
	 ...
	 */
	public void setContactRequests(List<FraugsterSignupContactRequest> contactRequests) {
