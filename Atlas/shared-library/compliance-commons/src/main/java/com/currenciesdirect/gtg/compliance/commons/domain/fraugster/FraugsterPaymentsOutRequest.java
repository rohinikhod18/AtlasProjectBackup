...
/**
 * The Class FraugsterPaymentsOutRequest.
 *
 * @author manish
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class FraugsterPaymentsOutRequest extends ServiceMessage implements Serializable {
	...
	private List<FraugsterPaymentsOutContactRequest> contactRequests;
	 ...
	 */
	public List<FraugsterPaymentsOutContactRequest> getContactRequests() {
	 ...
	 */
	public void setContactRequests(List<FraugsterPaymentsOutContactRequest> contactRequests) {
