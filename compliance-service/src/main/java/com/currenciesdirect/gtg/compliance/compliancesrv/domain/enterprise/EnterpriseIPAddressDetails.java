package com.currenciesdirect.gtg.compliance.compliancesrv.domain.enterprise;
...
public class EnterpriseIPAddressDetails extends ServiceMessageResponse implements Serializable{
   ...
   @JsonProperty(value = "longitude")
    ...
    @JsonProperty(value = "contact_ip")
    private Integer contactIp;
	 ...
	 */
	public void setContactIp(Integer contactIp) {
