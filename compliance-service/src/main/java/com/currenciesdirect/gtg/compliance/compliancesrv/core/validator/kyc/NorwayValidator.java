 ...
 *
 */
public class NorwayValidator implements IValidator {
	private static final Logger LOGGER = LoggerFactory.getLogger(NorwayValidator.class);
	...
	public Boolean validateRequest(Contact request) {
		...
		try {
			...
			LOGGER.warn("Failed Norway validations", exception);
