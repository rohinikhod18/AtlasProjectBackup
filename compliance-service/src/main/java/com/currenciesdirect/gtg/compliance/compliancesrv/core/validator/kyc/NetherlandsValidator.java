 ...
 *
 */
public class NetherlandsValidator implements IValidator {
	private static final Logger LOGGER = LoggerFactory.getLogger(NetherlandsValidator.class);
	...
	public Boolean validateRequest(Contact request) {
		...
		try {
			...
			LOGGER.warn("Failed Netherlands validations", exception);
