...
/**
 * The Class IntuitionPaymentINMQRequest.
 */
@Getter 
@Setter
public class IntuitionPaymentINMQRequest implements Serializable{
	...
	@JsonProperty(value = "CD_Collection_Bank")
	...
	@JsonProperty(value = "CD_Collection_bank_Acc_name")
	...
	private List<IntuitionMQFundsCalculations> calculations;
