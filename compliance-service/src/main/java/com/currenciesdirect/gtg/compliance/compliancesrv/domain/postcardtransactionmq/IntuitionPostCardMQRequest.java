...
@Getter 
@Setter
public class IntuitionPostCardMQRequest implements Serializable{
	...
	private List<IntuitionPostCardTransactionMQRequest> transaction;
	
	@JsonProperty(value = "Account")
	private List<IntuitionPostCardAccountMQRequest> account;
	
	@JsonProperty(value = "Chargeback_Dispute")
	private List<IntuitionPostCardChargebackMQRequest> chargeback;
	
	@JsonProperty(value = "Device_IP")
	private List<IntuitionPostCardIPDeviceMQRequest> ipDevice;
