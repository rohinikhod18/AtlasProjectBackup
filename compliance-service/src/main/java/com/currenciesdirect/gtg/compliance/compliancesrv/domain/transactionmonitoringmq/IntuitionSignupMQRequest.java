...
/**
 * The Class IntuitionSignupMQRequest.
 */
@Getter 
@Setter
public class IntuitionSignupMQRequest extends ServiceMessage implements Serializable{
	...
	private List<IntuitionAccountMQRequest> account;
	
	/** The cfxLegalEntity. */
	@JsonProperty(value = "CFX_Legal_Entity")
	private List<IntuitionCFXLegalEntityMQRequest> cfxLegalEntity;
	
	/** The contacts. */
	@JsonProperty(value = "Contact")
	private List<IntuitionContactMQRequest> contacts;
	
	/** The IPDevice. */
	@JsonProperty(value = "IP_Device")
	private List<IntuitionIPDeviceMQRequest> ipDevice;
	...
	private List<IntuitionCardMQRequest> card;
}
