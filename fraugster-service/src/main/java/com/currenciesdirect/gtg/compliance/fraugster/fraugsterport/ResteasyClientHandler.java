...
public class ResteasyClientHandler {
	...
	/** The stale monitor. */
	private static FraugsterIdleConnectionMonitorThread fStaleMonitor = null;
	...
	private ResteasyClientHandler() {
		...
		fStaleMonitor = new FraugsterIdleConnectionMonitorThread(cm);
...
class FraugsterIdleConnectionMonitorThread extends Thread {
	private static final Logger LOG = LoggerFactory.getLogger(FraugsterIdleConnectionMonitorThread.class);
	private final PoolingClientConnectionManager fConnMgr;
	private volatile boolean fraugsterShutdown;

	public FraugsterIdleConnectionMonitorThread(PoolingClientConnectionManager connMgr) {
		super();
