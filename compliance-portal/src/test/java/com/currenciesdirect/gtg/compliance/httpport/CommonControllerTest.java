...
public class CommonControllerTest {
	...
	public void testGetDashBoard() {
		ModelAndView modelAndView=commonController.getDashBoard();
	...
	public void testGetAdministration() {
		...
		ModelAndView modelAndView = commonController.getAdministration();
		assertEquals("Administration", modelAndView.getViewName());
	}

	@Test
	public void testUnauthorized() {
		ModelAndView modelAndView = commonController.unauthorized(getUser());
		assertEquals("UNAUTHORZIED", modelAndView.getViewName());
	}
