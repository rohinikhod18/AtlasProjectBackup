...
<main id="main-content" class="main-content--large">
		...
		<div class="grid">
			...
			<div class="grid__row">
				...
				<div class="grid__col--12">
					...
					<h1>
						Payments out Report <span class="breadcrumbs"> <span
							...
							<div id="main-content__body">
								...
								<div class="grid">
									...
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-ring">
										...
										<form id="payOutQueueForm"
											action="/compliance-portal/paymentOutDetail" method="POST">
											<table class="micro table-fix space-after">
												<thead>
													<tr>
														...
														<th id="col_UpdatedOn" class="sorted desc default-sort-desc">
															<a href="#" onclick="sortByField('UpdatedOn')">Date<i></i></a>
														</th>
														...
														<!-- <th id ="col_vValueDate" class="sorted desc"><a href="#" onclick="sortByField('vValueDate')">Value Date<i></i></a></th> -->
												...
												<tbody id="payOutQueueBody">
													...
													<c:forEach var="listValue"
														items="${paymentOutQueueDto.paymentOutQueue}"
														varStatus="loop">
														<%-- <c:set var="regDetailsUrl"
												value="/compliance-portal/paymentOutDetails?paymentOutId=${listValue.paymentOutId}" /> --%>
														<c:choose>
															<c:when
																test="${listValue.locked  && listValue.lockedBy==paymentOutQueueDto.user.name}">
																<tr class="owned talign"
																	data-ot="You own(s) this record">
															</c:when>
															<c:when test="${listValue.locked }">
																<tr class="talign unavailable"
																	data-ot="${listValue.lockedBy } own(s) this record">
															</c:when>
															<c:otherwise>
														...
														<td class=" nowrap number"><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.transactionId}</a></td>
														<td class="number"><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.clientId}</a></td>
														<td class="nowrap"><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.date}</a></td>
														<td class="wordwrapfixwidth"><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.contactName}</a></td>
														<td><a 
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)" 
															href="#" >${listValue.organisation}</a></td>
														<td><a 
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)" 
															href="#">${listValue.legalEntity}</a></td>
														<%-- <td><a 
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)" 
															href="#" >${listValue.valueDate}</a></td> --%>
														<td><a 
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)" 
															href="#" >${listValue.maturityDate}</a></td>
														<td ><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.type}</a></td>
														<td ><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.buyCurrency}</a></td>
														<td ><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.amount}</a></td>
														<td class="wordwrapfixwidth"><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.beneficiary}</a></td>
														<td class="wordwrapfixwidth" ><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.country}</a></td>
														<td ><a
															onClick="getPaymentOutQueueDetails(${listValue.paymentOutId},'${listValue.type}',this)"
															href="#">${listValue.overallStatus}</a></td>
										...
										<p id="pageCountDetails" style="display: none;">
											...
											<c:choose>
												<c:when
													test="${paymentOutQueueDto.page.totalRecords ge paymentOutQueueDto.page.pageSize}">
													<strong id="queueMinRecord">${paymentOutQueueDto.page.minRecord}</strong>
													<strong>-</strong>
													<strong id="queueMaxRecord">${paymentOutQueueDto.page.maxRecord}</strong>
												</c:when>
												<c:otherwise>
													<strong id="queueMinRecord">${paymentOutQueueDto.page.minRecord}</strong>
													<strong>-</strong>
										...
										<input type="hidden" id="queueTotalPages"
											value="${paymentOutQueueDto.page.totalPages}"></input>
									<ul class="horizontal containing pagination" id="paginationBlock" style="display: none;"><!-- style="display: none;"> -->		
										<c:if test="${paymentOutQueueDto.page.totalPages gt 1 }">
												...
												<li
													onClick="getSelectedPage(${paymentOutQueueDto.page.totalPages})"
													class="pagination__jump"
													value="${paymentOutQueueDto.page.totalPages}"><a id="lastPage"
												...
												<%-- <c:forEach var="i" begin="1"
													...
													<c:choose>
														...
														<c:otherwise>
															...
															<c:choose>
																<c:when
																	test="${i ge 11 && paymentOutQueueDto.page.totalPages ne i}">
																	<li id="page${i }" onClick="getSelectedPage(${ i })"
	...
	<li class="pagination__page">
		<a href="#" title="Page 20">20</a>
										...
										<span class="annex-tab annex-trigger"> <i
									...
									<form class="frm-table-filters" id="queueFilterForm"
										...
										<div class="grid-annex-side grid__col--3 hidden">
											...
											<div class="annex annex--hidden">
												...
												<h2>
													Generate report <span class="f-right annex-trigger"><i
	 ...
	 <fieldset>
	 	<ul class="button-group">
																<li><a href="#"
																	...
																	onclick="clearAndApplyFilter()">Clear</a></li>
																...
																<li>
																	<div class="hoverpanel--right hoverpanel--small">
																		...
																		<div class="hoverpanel__content--small">
																			<ul class="block-list">
																				<li>
																					<a href="#" class="icon-link--msexcel"
																					onclick="checkTotalRecordsAndDownload()">Microsoft
																						Excel</a>
																				</li>																				
																			</ul>
																...
																<li>
																	<!-- <img id="ajax-loader-clear-search" class="ajax-loader " src="/img/ajax-loader.svg" width="20" height="20" alt="Loading..."/> -->
																</li>
																...
																<div class="clickpanel__content--hidden">
																	...
																	<fieldset>
																		...
																		<ul class="multilist__options">
																			...
																			<c:forEach var="paymentStatus"
																				items="${paymentOutQueueDto.paymentStatus}"
																				varStatus="loop">

																				<li><label for="chk-status-${loop.index}">
																						<input name="paymentStatus[]" class="filterInput"
																						id="chk-status-${loop.index}" type="checkbox"
 ...
 --%>
														<li class="form__field-wrap filterInputWrap">
															...
															<div id="multilist-add-to-watchlists"
																...
																<div class="clickpanel__content--hidden">
																	...
																	<fieldset>
																		<input  id="filterSearchListWatchListId" class="multilist__search space-after"
																			type="search" placeholder="Search list">
																		<ul class="multilist__options">

																			<c:forEach var="watchListReason"
																				items="${paymentOutQueueDto.watchList.watchlistData}"
																				varStatus="loop">

																				<li><label for="chk-watchList-${loop.index}">
																						<input name="watchListReason[]"
																						class="filterInput"
																						id="chk-watchList-${loop.index}" type="checkbox"
																						value="${watchListReason.id}" />${watchListReason.name}
																				</label></li>
														...
														<li class="form__field-wrap filterInputWrap">
															...
															<p class="label filterInputHeader">
																Owner
																<!-- <span class="label__support">(who's working on it)</span> -->
															</p>
															<div id="singlelist-owner"
																class="multilist clickpanel--right">
																...
																<div class="clickpanel__content--hidden">
																	...
																	<fieldset>
																		<input  id="filterSearchListOwnerId" class="multilist__search space-after"
																			type="search" placeholder="Search list">
																		<ul class="multilist__options">

																			<c:forEach var="owner"
																				items="${paymentOutQueueDto.owner}" varStatus="loop">

																				<li><label for="chk-owner-${loop.index}">
																						<input name="owner[]" class="filterInput"
																						id="chk-owner-${loop.index}" type="checkbox"
																						value="${owner}" />${owner}
																				</label></li>
														...
														<ul class="form__fields">
																...
																<li class="form__field-wrap filterInputWrap">
																	...
																	<div id="multilist-organisations"
																		class="multilist clickpanel--right">
																			...
																			<fieldset>
																				...
																				<ul class="multilist__options">
																					...
																					<c:forEach var="organization"
																						items="${paymentOutQueueDto.organization}"
																						varStatus="loop">

																						<li><label for="chk-org-cduk-${loop.index}">
																								<input name="organization[]" class="filterInput"
																								id="chk-org-cduk-${loop.index}" type="checkbox"
															...
															<!-- legal entity changes end -->
																		...
																		<div class="grid__row">
																			<div class="grid__col--6 filterInputWrap">
																				<label for="date-payment-from"
																					...
																					class="datepicker filterInput" type="text" value="${paymentOutQueueDto.dateFrom}"
																					placeholder="dd/mm/yyyy" />
																			</div>
																			<div class="grid__col--6 filterInputWrap">
																				<label for="date-payment-to"
																					class="filterInputHeader">Date to</label> <input
																					id="date-payment-to" name="dateTo"
																					class="datepicker filterInput" type="text"  value="${paymentOutQueueDto.dateTo}"
																					placeholder="dd/mm/yyyy" />
																			</div>
																		</div>
																	</div>
																...
																<li class="form__field-wrap filterInputWrap">
																	...
																	<div id="multilist-buy-currency"
																		...
																		<div class="clickpanel__content--hidden">
																			...
																			<fieldset>
																				<input id="filterSearchListBuyCurrencyId" class="multilist__search space-after"
																					type="search" placeholder="Search list">
																				<ul class="multilist__options">

																					<c:forEach var="currency"
																						items="${paymentOutQueueDto.currency}"
																						varStatus="loop">
																						<li><label
																							for="chk-buy-currency-${loop.index}"> <input
																								name="buyCurrency[]" class="filterInput"
																								id="chk-buy-currency-${loop.index}"
																...
																<li class="form__field-wrap filterInputWrap">
																	...
																	<p class="label filterInputHeader">Country of
																		beneficiary</p>

																	<div id="multilist-country-of-fund"
																		class="multilist clickpanel--right">
																		...
																		<div class="clickpanel__content--hidden">
																			...
																			<fieldset>
																				<input  id="filterSearchListCountryOfBeneId" class="multilist__search space-after"
																					type="search" placeholder="Search list">
																				<ul class="multilist__options">

																					<c:forEach var="country"
																						items="${paymentOutQueueDto.country}"
																						varStatus="loop">

																						<li><label for="chk-country-${loop.index}">
																								<input name="countryOfBeneficiary[]"
																								class="filterInput"
																								id="chk-country-${loop.index}" type="checkbox"
																				...
																				<fieldset class="filterInputWrap">
																					...
																					<ul id="pillchoice-watchlist" class="pill-choice">
																						<li><label
																							...
																							for="rad-watchlist-passed"> <input
																								name="watchListStatus[]" value="PASS"
																								id="rad-watchlist-passed" value="PASS"
																								type="radio" class="filterInput" /> <i
																								class="material-icons">check</i>
																						</label></li>
																						<li><label
																							class="pill-choice__choice--negative"
																							for="rad-watchlist-failed"> <input
																								name="watchListStatus[]" value="FAIL"
																								id="rad-watchlist-failed" value="FAIL"
																								type="radio" class="filterInput" /> <i
																			...
																			<div class="grid__col--6 grid__col--pad-bottom fraud-field">
																				...
																				<fieldset class="filterInputWrap">
																					...
																					<ul id="pillchoice-fraugster" class="pill-choice">
																						<li><label
																							class="pill-choice__choice--positive"
																							for="rad-fraugster-passed"> <input
																								name="fraugsterStatus[]" value="PASS"
																								id="rad-fraugster-passed" type="radio"
																								class="filterInput" /> <i
																								class="material-icons">check</i>
																						</label></li>
																						<li><label
																							class="pill-choice__choice--negative"
																							for="rad-fraugster-failed"> <input
																								name="fraugsterStatus[]" value="FAIL"
																								id="rad-fraugster-failed" type="radio"
																								class="filterInput" /> <i
																								class="material-icons">close</i>
																						</label></li>
																					</ul>
																			...
																			<div class="grid__col--6 grid__col--pad-bottom  sanction-field">
																				...
																				<fieldset class="filterInputWrap">
																					...
																					<ul id="pillchoice-sanction" class="pill-choice">
																						<li><label
																							class="pill-choice__choice--positive"
																							for="rad-sanction-passed"> <input
																								name="sanctionStatus[]" value="PASS"
																								id="rad-sanction-passed" type="radio"
																								class="filterInput" /> <i
																								class="material-icons">check</i>
																						</label></li>
																						<li><label
																							class="pill-choice__choice--negative"
																							for="rad-sanction-failed"> <input
																								name="sanctionStatus[]" value="FAIL"
																								id="rad-sanction-failed" type="radio"
																								class="filterInput" /> <i
																								class="material-icons">close</i>
																						</label></li>
																					</ul>
																			...
																			<div class="grid__col--6 grid__col--pad-bottom blackList-field">
																				...
																				<fieldset class="filterInputWrap">
																					...
																					<ul id="pillchoice-blacklist" class="pill-choice">
																						<li><label
																							class="pill-choice__choice--positive"
																							for="rad-blacklist-passed"> <input
																								name="blacklistStatus[]"
																								id="rad-blacklist-passed" value="PASS"
																								type="radio" class="filterInput" /> <i
																								class="material-icons">check</i>
																						</label></li>
																						<li><label
																							class="pill-choice__choice--negative"
																							for="rad-blacklist-failed"> <input
																								name="blacklistStatus[]"
																								id="rad-blacklist-failed" value="FAIL"
																								type="radio" class="filterInput" /> <i
																								class="material-icons">close</i>
																						</label></li>
																					</ul>
																				...
																				<fieldset class="filterInputWrap">
																					...
																					<ul id="pillchoice-customCheck" class="pill-choice">
																						<li>
																							<label 
																							class="pill-choice__choice--positive" 
																							for="rad-customCheck-passed"> <input 
																							name="customCheckStatus[]" 
																							id="rad-customCheck-passed"  value="PASS" 
																							type="radio" class="filterInput"   /><i 
																							class="material-icons">check</i>			
																							</label></li>
																						<li> <label 
																							class="pill-choice__choice--negative" 
																							for="rad-customCheck-failed"> <input 
																							name="customCheckStatus[]" 
																							id="rad-customCheck-failed"  value="FAIL" 
																							type="radio" class="filterInput"   /><i 
																							class="material-icons">close</i>			
																							</label></li>
																					</ul>
																				...
																				<fieldset class="filterInputWrap">
																					...
																					<ul id="pillchoice-intuitionStatus" class="pill-choice">
																						<li>
																							<label 
																							class="pill-choice__choice--positive" 
																							for="rad-intuitionStatus-passed"> <input 
																							name="intuitionStatus[]" 
																							id="rad-intuitionStatus-passed"  value="PASS" 
																							type="radio" class="filterInput"   /><i 
																							class="material-icons">check</i>			
																							</label></li>
																						<li> <label 
																							class="pill-choice__choice--negative" 
																							for="rad-intuitionStatus-failed"> <input 
																							name="intuitionStatus[]" 
																							id="rad-intuitionStatus-failed"  value="FAIL" 
																							type="radio" class="filterInput"   /><i 
																							class="material-icons">close</i>			
																							</label></li>
																					</ul>
																				...
																				<fieldset class="filterInputWrap">
																					...
																					<ul id="pillchoice-transactionMonitoringRequest" class="pill-choice">
																						<li>
																							<label 
																							class="pill-choice__choice--positive" 
																							for="rad-transactionMonitoringRequest-passed"> <input 
																							name="transactionMonitoringRequest[]" 
																							id="rad-transactionMonitoringRequest-passed"  value="PASS" 
																							type="radio" class="filterInput"   /><i 
																							class="material-icons">check</i>			
																							</label></li>
																						<li> <label 
																							class="pill-choice__choice--negative" 
																							for="rad-transactionMonitoringRequest-failed"> <input 
																							name="transactionMonitoringRequest[]" 
																							id="rad-transactionMonitoringRequest-failed"  value="FAIL" 
																							type="radio" class="filterInput"   /><i 
																							class="material-icons">close</i>			
																							</label></li>
																					</ul>
													...
													<section class="section--actions">
													 <h2 id= "defaultMonth" style="visibility:hidden">Date defaults to last 6 months </h2>
														<input id="payOut_report_Filter" type="button" class="button--primary button--small" onclick="applyPaymentOutSearchCriteria()" value="Generate" />
														...
														<object id="gifloaderforPayOutreport" class="ajax-loader-lock-toggle" height="50" width="50" data="resources/img/ajax-loader.svg" preserveAspectRatio="xMidYMid slice" viewBox="0 0 16 16" type="image/svg+xml" style="visibility:hidden;"></object>
													</section>
									...
									<form id="payOutReportDownLoadForm" action="/compliance-portal/paymentOutReportDownLoad" method="POST" >
...
<input type="hidden" id="isFromDetails" value="${paymentOutQueueDto.isFromDetails}"/>
<input type="hidden" id="pageType" value="PaymentOutReport"/>
</div>
	...
	<script type="text/javascript" src="resources/js/paymentOutReport.js"></script>
