	 ...
	 <c:choose>
		...
		<div class="grid">
					...
					<form id="redirectQueueForm" action="${redirectUrl }" method="post">
					 ...
					 <div class="grid__col--3">
						...
						<div class="toast">
							...
							<c:if test="${paymentOutDetails.noOfContactsForAccount > 0}">
								<span class="message--toast rhs page-load"> <i
									class="material-icons">assignment_ind</i> <a
									 onclick="openClientDetail()" class="accordion-trigger" href="#">${paymentOutDetails.noOfContactsForAccount}
								...
								<div class="grid__col--8 grid__col--pad-right">
												...
												<div class="grid__row">
													...
													<div class="grid__col--4">
														<dl class="split-list">
															...
															<dd>
																<span class="wordwrap" id="contact_name"><a href="#accordion-section-client-details" class="accordion-trigger" data-accordion-section="accordion-section-client-details" >
																${paymentOutDetails.name}</a></span>
														  ...
														  <!-- AT-3471 -->
															...
															<dd id="leaglEntity">${paymentOutDetails.paymentOutInfo.initialStatus}</dd>
															<!-- AT-4187 -->
													...
													<div class="grid__col--4 grid__col--pad-left">
														<dl class="split-list">
															...
															<dd id="valuedate">${paymentOutDetails.paymentOutInfo.maturityDate}</dd>
															...
															<c:choose>
																...
																<c:when test="${paymentOutDetails.account.company.etailer}">
													...
													<div class="grid__col--4 grid__col--pad-left">
														<dl class="split-list">
															...
															<dd>
															 ...
															 <dd>${paymentOutDetails.account.annualFXRequirement}</dd>
									...
									<section class="main-content__section">
										...
										<div class="accordion--quick-controls">
											...
											<div class="accordion__section">
												<div class="accordion__header"
													...
													<a href="#"><i class="material-icons">add</i>Blacklist
														...
														<c:choose>
															<c:when
																test="${paymentOutDetails.blacklist.benficiaryBlacklist.isRequired}">
																<c:if
														...
														</c:choose> <!-- End of - Condition added by Vishal J to show NOT REQUIRED status on UI -->
													</a>
												</div>
											...
											<div id="accordion-section-corporate"
												class="accordion__section">

												<div id="payOutDetails_corporate_indicatior"
													class="accordion__header">
															...
															<div class="grid__row">
																...
																<div class="grid__col--4">
																	<dl class="split-list">
																		...
																		<dt>SIC code</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.sic}</dd>

																		<dt>SIC description</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.sicDesc}</dd>

																		<dt>Registration number</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.registrationNumber}</dd>

																		<dt>Former name</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.formerName}</dd>

																		<dt>Legal form</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.legalForm}</dd>
																		
																		<!-- newly added Dnb data  -->
																		
																		<dt>Global ultimate duns</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.globalUltimateDuns}</dd>
																		
																		<dt>Global ultimate name</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.globalUltimateName}</dd>
																		
																		<dt>Global ultimate country</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.globalUltimateCountry}</dd>
																		
																	
																		<dt>Registration date</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.registrationDate}</dd>
																				</dl>
																</div>
																<div class="grid__col--4 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		<dt>Match name</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.matchName}</dd>
																		
																
																		
																		<dt>Iso country code two digit</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.isoCountryCode2Digit}</dd>
																		
																		<dt>Iso country code three digit</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.isoCountryCode3Digit}</dd>
																		
																		<dt>Statement date</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.statementDate}</dd>
																		
																	

																		<dt>Foreign owned company</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.foreignOwnedCompany}</dd>

																		<dt>Net worth</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.netWorth}</dd>
																	

																		<dt>Fixed assets</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.fixedAssets}</dd>
																		
																		<dt>Total liabilities and equities</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.totalLiabilitiesAndEquities}</dd>

																		<dt>Total share holders</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.totalShareHolders}</dd>
																...
																<div class="grid__col--4 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		<dt>Gross income</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.grossIncome}</dd>
																		
																
																		
																		<dt>Net income</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.netIncome}</dd>
																		
																		<dt>Total current assets</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.totalCurrentAssets}</dd>
																		
																		<dt>Total assets</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.totalAssets}</dd>
																		
																		<dt>Total longterm liabilities</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.totalLongTermLiabilities}</dd>
																		
																
																		
																		<dt>Total current liabilities</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.totalCurrentLiabilities}</dd>
																		
																		
																		<dt>Total matched shareholders</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.totalMatchedShareholders}</dd>
																		
																		<dt>Financial strength</dt>
																		<dd>${paymentOutDetails.account.corperateCompliance.financialStrength}</dd>
			...
			<input type="button" class="button--primary" value="Get new data"/>
											...
											<div id="accordion-section-country"
												...
												<div id="payOutDetails_countrycheck_indicatior"
													...
													<a href="#"><i class="material-icons">add</i>Country
														Check <!-- Condition added by Vishal J to show NOT REQUIRED status on UI -->
														<c:choose>
															<c:when
																test="${paymentOutDetails.customCheck.countryCheck.isRequired}">
																<c:if
												...
												<div class="accordion__content">
													...
													<a href="javascript:void(0);"
														id="viewMoreDetailsPayOut_CountryChk"
														class="load-more space-after"
														onclick="viewMoreDetails('COUNTRYCHECK' ,'countryCheck_beneficiary','countryCheckTotalRecordsPayOutId','leftRecordsPayOutIdCountryChk','BENEFICIARY');">
														VIEW <span class="load-more__extra"
														id="viewMorePayOut_CountryChkId"> </span> MORE <span
														class="load-more__left" id="leftRecordsPayOutIdCountryChk">
													</span>
													</a>
											...
											<div id="accordion-section-custom" class="accordion__section">
												...
												<div id="payOutDetails_customchecks_indicatior"
													...
													<a href="#"><i class="material-icons">add</i>Custom
														checks <!-- Condition added by Vishal J to show NOT REQUIRED status on UI -->
														<c:choose>
															<c:when
																test="${paymentOutDetails.customCheck.paymentOutCustomCheck.isRequired}">
																<c:if
												...
												<div class="accordion__content">
																		...
																		<tr class="talign">
																			...
																			<td>
																				<ul>
																					...
																					<li class="breakwordHeader">Beneficiary Check :
													...
													<a href="javascript:void(0);"
														id="viewMoreDetailsPayOut_CusChk"
														class="load-more space-after"
														onclick="viewMoreDetails('VELOCITYCHECK' ,'customChecks','customCheckTotalRecordsPayOutId','leftRecordsPayOutIdCusChk','BENEFICIARY');">
														VIEW <span class="load-more__extra"
														id="viewMorePayOut_CusChkId"> </span> MORE <span
														class="load-more__left" id="leftRecordsPayOutIdCusChk">
											...
											<object class="ajax-loader-lock-toggle" height="50" width="50" data="resources/img/ajax-loader.svg" preserveAspectRatio="xMidYMid slice" viewBox="0 0 16 16" type="image/svg+xml">
													...
													<form>
														<p class="flush-margin">
															<input id="payout_customChecks_recheck" type="button"
																onClick="resendCustomCheck();"
																class="<c:out value="${buttonClass} custom-field"/>"
																value="Repeat checks" <c:out value="${buttonDisable}"/> />
																...
																<span id="payout_customChecks_recheck_error_field" class="form__field-error" hidden="hidden">
														...
														data-modal="modal-original-summary" value="WHITE LIST DATA" onclick="showAccountWhiteListData('${paymentOutDetails.account.id}' , '${paymentOutDetails.account.orgCode}')">
											...
											<div class="accordion__section">
												...
												<div class="accordion__header"
													...
													<a href="#"><i class="material-icons">add</i>Sanctions
														Contact <!-- Condition added by Vishal J to show NOT REQUIRED status on UI -->
														<c:choose>
															<c:when
																test="${paymentOutDetails.sanction.contactSanction.isRequired}">
																<c:if
														...
														<table>
															<thead>
																<tr>
																	...
																	<th class="sorted desc">Updated on <i></i>
																	</th>
																	<th>Updated by</th>
																	<th>Sanction ID</th>
																	<th>OFAC List</th>
											...
											<div class="accordion__section">
												<div class="accordion__header"
													...
													<a href="#"><i class="material-icons">add</i>Sanctions
														Beneficiary <!-- Condition added by Vishal J to show NOT REQUIRED status on UI -->
														<c:choose>
															<c:when
																test="${paymentOutDetails.sanction.beneficiarySanction.isRequired}">
																<c:if
		...
		<a href="#"><i class="material-icons">add</i>Sanctions Bank<span class="indicator--negative">3</span></a>
												...
												<div class="accordion__header"
													...
													<a href="#"><i class="material-icons">add</i>Sanctions
														Bank <!-- Condition added by Vishal J to show NOT REQUIRED status on UI -->
														<c:choose>
															<c:when
																test="${paymentOutDetails.sanction.bankSanction.isRequired}">
																<c:if
															...
															<div class="grid__row">
																...
																<div class="grid__col--4">
																	<dl class="split-list">
																		...
																		<dd>${paymentOutDetails.account.riskProfile.countryRiskIndicator}</dd>

																		<dt>Risk trend</dt>
																		<dd>${paymentOutDetails.account.riskProfile.riskTrend}</dd>

																		<dt>Risk direction</dt>
																		<dd>${paymentOutDetails.account.riskProfile.riskDirection}</dd>

																		<!-- newly added fields for DNB DATA  -->
																		<dt>Continent</dt>
																		<dd>${paymentOutDetails.account.riskProfile.continent}</dd>


																		<dt>Country</dt>
																		<dd>${paymentOutDetails.account.riskProfile.country}</dd>


																		<dt>State country</dt>
																		<dd>${paymentOutDetails.account.riskProfile.stateCountry}</dd>

																		<dt>Duns number</dt>
																		<dd>${paymentOutDetails.account.riskProfile.dunsNumber}</dd>


																		<dt>Trading styles</dt>
																		<dd>${paymentOutDetails.account.riskProfile.tradingStyles}</dd>
																		
																	

																		<dt>us1987PrimarySic4Digit</dt>
																		<dd>${paymentOutDetails.account.riskProfile.us1987PrimarySic4Digit}</dd>


																		<dt>Financial figures month</dt>
																		<dd>${paymentOutDetails.account.riskProfile.financialFiguresMonth}</dd>

																	
																
																		<dt>Financial figures year</dt>
																		<dd>${paymentOutDetails.account.riskProfile.financialFiguresYear}</dd>
																...
																<div class="grid__col--4 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		<dd>${paymentOutDetails.account.riskProfile.financialYearEndDate}</dd>


																		<dt>Annual sales</dt>
																		<dd>${paymentOutDetails.account.riskProfile.annualSales}</dd>


																		<dt>Modelled annual sales</dt>
																		<dd>${paymentOutDetails.account.riskProfile.modelledAnnualSales}</dd>

																		<dt>Net worth amount</dt>
																		<dd>${paymentOutDetails.account.riskProfile.netWorthAmount}</dd>

																		<dt>Credit limit</dt>
																		<dd>${paymentOutDetails.account.riskProfile.creditLimit}</dd>
																		
															
																		<dt>Updated risk</dt>
																		<dd>${paymentOutDetails.account.riskProfile.updatedRisk}</dd>

																		<dt>Failure score</dt>
																		<dd>${paymentOutDetails.account.riskProfile.failureScore}</dd>

																		<dt>Delinquency failure score</dt>
																		<dd>${paymentOutDetails.account.riskProfile.delinquencyFailureScore}</dd>

																		<!-- newly added fields for DNB DATA  -->

																		<dt>Modelled networth</dt>
																		<dd>${paymentOutDetails.account.riskProfile.modelledNetWorth}</dd>
																	

																		<dt>Location type</dt>
																		<dd>${paymentOutDetails.account.riskProfile.locationType}</dd>

																		<dt>Import export indicator</dt>
																		<dd>${paymentOutDetails.account.riskProfile.importExportIndicator}</dd>
																...
																<div class="grid__col--4 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		<dd>${paymentOutDetails.account.riskProfile.domesticUltimateRecord}</dd>

																		<dt>Global ultimate record</dt>
																		<dd>${paymentOutDetails.account.riskProfile.globalUltimateRecord}</dd>
																		

																		<dt>GroupStructure number of levels</dt>
																		<dd>${paymentOutDetails.account.riskProfile.groupStructureNumberOfLevels}</dd>

																		<dt>Headquarter details</dt>
																		<dd>${paymentOutDetails.account.riskProfile.headquarterDetails}</dd>

																		<dt>Immediateparent details</dt>
																		<dd>${paymentOutDetails.account.riskProfile.immediateParentDetails}</dd>

																		<dt>Domestic ultimate parent details</dt>
																		<dd>${paymentOutDetails.account.riskProfile.domesticUltimateParentDetails}</dd>

																		<dt>Global ultimate parent details</dt>
																		<dd>${paymentOutDetails.account.riskProfile.globalUltimateParentDetails}</dd>

																		<dt>Risk rating</dt>
																		<dd>${paymentOutDetails.account.riskProfile.riskRating}</dd>

																		<dt>Profit loss</dt>
																		<dd>${paymentOutDetails.account.riskProfile.profitLoss}</dd>
																		</dl>
																</div>
 ...
 -->
											...
											<div class="accordion__section">
												...
												<div id="payOutDetails_fraugster_indicatior"
													class="accordion__header">
													<a href="#" href="#"  onclick="showProviderResponse('${paymentOutDetails.fraugster.id}','FRAUGSTER','FraugsterChart')"><i class="material-icons">add</i>FRAUDPREDICT
												...
												<div class="accordion__content">
													...
													<table>
														<thead>
															<tr href="#"  onclick="showProviderResponse('${paymentOutDetails.fraugster.id}','FRAUGSTER','FraugsterChart')">
																<th class="tight-cell sorted desc">Created on <i></i>
																</th>
																<th>Updated by</th>
																<th>Fraugster Id</th>
																<th>Score</th>
														...
														<tbody id="fraugster">
															<tr href="#"  onclick="showProviderResponse('${paymentOutDetails.fraugster.id}','FRAUGSTER','FraugsterChart')">
																<td hidden="hidden">${paymentOutDetails.fraugster.id }</td>
																<td>${paymentOutDetails.fraugster.createdOn }</td>
																<td>${paymentOutDetails.fraugster.updatedBy }</td>
																...
																<!--<td class="nowrap">${paymentOutDetails.fraugster.score }</td>-->
																<td class="nowrap">Not Required</td>
																<td id="fraugster_status" class="center"><i class="material-icons">-</i></td>
																<%--<c:choose>
																<c:when test="${paymentOutDetails.fraugster.status }">
																	<td id="fraugster_status" class="yes-cell"><i
																	class="material-icons">check</i></td>
																</c:when>
																<c:when test="${paymentOutDetails.fraugster.status eq false}">
																	<td id="fraugster_status" class="no-cell"><i
																	class="material-icons">clear</i></td>
																</c:when>
																
																<c:when test="${paymentOutDetails.fraugster.status ne true}">
																	<td class="nowrap">${paymentOutDetails.fraugster.status }</td>
																</c:when>
																<c:otherwise>
																	<td class="nowrap">${paymentOutDetails.fraugster.status }</td>
																</c:otherwise>
													...
													<%-- <form>
			<p class="flush-margin"><input type="button" class="<c:out value="${buttonClass}"/>"  value="Repeat checks" <c:out value="${buttonDisable}"/> /></p>
		</form> --%>
													<form>
														<p class="flush-margin">
															<input id="payout_fraugster_recheck" type="button"
																onClick="resendFraugsterCheck();"
																class="button--primary button--disabled custom-field"
																value="Repeat checks" <c:out value="${buttonDisable}"/> />
																		...
																		<div class="grid__col--6">
																			...
																			<div class="form__field-wrap">
																				...
																				<div id="singlelist-document-type"
																					...
																					<p id="docTypeSelectionCfxId" class="singlelist__chosen clickpanel__trigger">Please
																						select</p>
																						...
																						<fieldset>
																							...
																							<ul class="singlelist__options multilist__options">
																								...
																								<c:forEach var="documentList"
																									items="${paymentOutDetails.documentList}"
																									varStatus="loop">

																									<li><label for="rad-doctype-${loop.index}">
						...
						<div class="accordion__section">
							...
							<div id="payOutDetails_fraugster_indicatior"
								class="accordion__header">
								<a href="#"><i class="material-icons">add</i>Fraugster</a>
							</div>
								...
								<table>
									...
									<tbody id="fraugster">
										<tr>
											...
											<td>${paymentOutDetails.fraugster.updatedBy }</td>
											<td>
												<%-- <a href="#">${paymentOutDetails.fraugster.fraugsterId }</a> --%>
												<a href="#"
												onclick="showProviderResponse('${paymentOutDetails.fraugster.id}','FRAUGSTER')">${paymentOutDetails.fraugster.fraugsterId }</a>
											</td>
											<td class="number">${paymentOutDetails.fraugster.score }</td>
										</tr>
									</tbody>
								</table>
								<a href="javascript:void(0);" id="viewMoreDetailsPayOut_Fraug"
									class="load-more space-after"
									onclick="viewMoreDetails('FRAUGSTER' ,'fraugster','fraugsterTotalRecordsPayOutId','leftRecordsPayOutIdFraug','CONTACT');">
									VIEW <span class="load-more__extra" id="viewMorePayOut_FraugId">
								</span> MORE <span class="load-more__left"
									id="leftRecordsPayOutIdFraug"> </span> <!-- <img class="ajax-loader-lock-toggle" src="resources/img/ajax-loader.svg" type="image/svg+xml" width="16" height="16" alt="Loading..."> -->
									<!-- <object class="ajax-loader-lock-toggle" height="50" width="50" data="resources/img/ajax-loader.svg" preserveAspectRatio="xMidYMid slice" viewBox="0 0 16 16" type="image/svg+xml">
											</object> 
								</a>
															...
															<div class="grid__row">
																...
																<div class="grid__col--6">
																	<dl class="split-list">
																		...
																		<dd id="contact_FurtherClient_email">
																			${paymentOutDetails.currentContact.email}</dd>
																...
																<div class="grid__col--6 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		onclick="showDeviceInfo('${paymentOutDetails.account.id}')">
									...
									<section id="pagepanel">
										...
										<form>
											...
											<section class="watchlist-field">
												...
												<!-- update status section starts here -->											
												<section>
																					...
																					<c:choose>
																						...
																						<c:otherwise>
																							<label 
																							    ...
																							    class="pill-choice__choice--positive"
																								for="rad-status-clear"> <input
																								id="rad-status-clear" type="radio"
																								name="paymentStatus"
																								value="${statusData.status }"
												...
												<section class="section--actions">
													...
													<c:choose>
														<c:when
															test="${(paymentOutDetails.locked == null || !paymentOutDetails.locked)}">
				...
				<c:when test="${paymentOutDetails.isPagenationRequired==true}">
					<ul id="paginationBlock" class="pagination--fixed page-load">
						<li class="pagination__jump--disabled"><a id="firstRecord"
							onclick="getPayOutFirstRecord('${paymentOutDetails.paginationDetails.firstRecord.custType}','${paymentOutDetails.paginationDetails.firstRecord.id}');"
							href="#" data-ot="First record"><i class="material-icons">first_page</i></a></li>
						<li class="pagination__jump"><a id="previousRecord"
							onclick="getPayOutPreviousRecord('${paymentOutDetails.paginationDetails.prevRecord.custType}','${paymentOutDetails.paginationDetails.prevRecord.id}');"
							href="#" data-ot="Previous record"><i class="material-icons">navigate_before</i></a>
						</li>
						<li class="pagination__jump"><a id="nextRecord"
							onclick="getPayOutNextRecord('${paymentOutDetails.paginationDetails.nextRecord.custType}','${paymentOutDetails.paginationDetails.nextRecord.id}');"
							href="#" data-ot="Next record"><i class="material-icons">navigate_next</i></a>
						</li>
						<li class="pagination__jump"><a id="lastRecord"
							onclick="getPayOutLastRecord('${paymentOutDetails.paginationDetails.totalRecords.custType}','${paymentOutDetails.paginationDetails.totalRecords.id}');"
							href="#" data-ot="Last record"><i class="material-icons">last_page</i></a>
						</li>
						<li class="pagination__text">Record <strong
							id="currentRecord">${paymentOutDetails.currentRecord }</strong>
	...
	<div id="drawer-user" class="drawer--closed">
		...
		<input type="hidden" id="searchCriteria" value='${paymentOutDetails.searchCriteria}' /> 
		<input type="hidden" id="contact_contactId" value='${paymentOutDetails.currentContact.id}' />
		<input type="hidden" id="contact_crmAccountId"value='${paymentOutDetails.currentContact.crmAccountId}' />
		<input type="hidden" id="contact_crmContactId" value='${paymentOutDetails.currentContact.crmContactId}' /> 
		<input type="hidden" id="contact_accountId" value='${paymentOutDetails.currentContact.accountId}' /> 
		<input type="hidden" id="userResourceId" value='${paymentOutDetails.userResourceId}' />
		<input type="hidden" id="paymentOutId" value='${paymentOutDetails.paymentOutInfo.id}' />
		...
		<input type="hidden" id="fraugsterTotalRecordsPayOutId"
			...
			type="hidden" id="customCheckTotalRecordsPayOutId"
			value='${paymentOutDetails.customCheck.paymentOutCustomCheck.totalRecords}' />
		...
		<!-- set sanction Contact, Bank and Beneficiary status  value on loading and after repeat check, this value are used to update sanction status in paymentout table : Abhijit G -->
		<input type="hidden" id="paymentOutSanctionContactStatus"
			value='${paymentOutDetails.sanction.contactSanction.statusValue}' />
		<input type="hidden" id="paymentOutSanctionBeneficiaryStatus"
			value='${paymentOutDetails.sanction.beneficiarySanction.statusValue }' />
		<input type="hidden" id="paymentOutSanctionBankStatus"
			value='${paymentOutDetails.sanction.bankSanction.statusValue }' />
		<input type="hidden" id="fraugster_eventServiceLogId" 
			value='${paymentOutDetails.fraugster.id}' />
