...
<body>
					...
					<div class="grid__col--9">
					 ...
					 <div class="grid__col--3">
								...
								<div class="toast">
									...
									<c:if test="${paymentInDetails.noOfContactsForAccount > 0}">
										<span class="message--toast rhs page-load"> <i
											class="material-icons">assignment_ind</i> <a
											 onclick="openClientDetail()" class="accordion-trigger" href="#">${paymentInDetails.noOfContactsForAccount}
							...
							<div class="grid__row">
								...
								<div class="grid__col--8 grid__col--pad-right">
												...
												<div class="grid__row">
													...
													<div class="grid__col--4">
														<dl class="split-list">
															...
															<c:choose>
																...
																<c:when test="${paymentInDetails.account.company.etailer}">
															...
															<dt>Website</dt>
															<dd class="wordwrap" id="account_website">${paymentInDetails.account.website}</dd>
															
															<dt>Phone</dt>
															<dd id="contact_phone">${paymentInDetails.currentContact.phone}</dd>
													...
													<div class="grid__col--4 grid__col--pad-left">
														<dl class="split-list">
															...
															<dd id="account_organisation" hidden="true">${paymentInDetails.account.orgCode}</dd>
														
														    <dt>Industry</dt>
															<dd id="account_inustry">${paymentInDetails.account.company.industry}</dd>
														
															<dt>Reversal Date</dt>
															<dd id="reversal_date">${paymentInDetails.paymentInInfo.updatedOn}</dd>
														
														 <dt>Annual FX Turnover</dt>
															 <dd>${paymentInDetails.account.annualFXRequirement}</dd>
													...
													<div class="grid__col--4 grid__col--pad-left">
														<dl class="split-list">
															...
															<dd id="account_primaryContact">${paymentInDetails.primaryContactName}</dd>

															<dt>SIC description</dt>
															<dd id="sic_description">${regDetails.account.corperateCompliance.sicDesc}</dd>
									...
									<section class="main-content__section">
													...
													<form>
														<p class="flush-margin">
															<input id="payin_customChecks_recheck" type="button" onClick="resendCustomCheck();"
																...
																value="Repeat checks" disabled = "disabled">
														...
														data-modal="modal-original-summary" value="WHITE LIST DATA" onclick="showAccountWhiteListData('${paymentInDetails.account.id}' , '${paymentInDetails.account.orgCode}')">
														...
														<div class="grid">
															...
															<div class="grid__row">
																...
																<div class="grid__col--4">
																	<dl class="split-list">
																		<dt>SIC code</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.sic}</dd>
																		
																		<dt>SIC description</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.sicDesc}</dd> 

																		<dt>Registration number</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.registrationNumber}</dd>

																		<dt>Former name</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.formerName}</dd>

																		<dt>Legal form</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.legalForm}</dd>
																		
																		<!-- newly added Dnb data  -->
																		
																		<dt>Global ultimate duns</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.globalUltimateDuns}</dd>
																		
																		<dt>Global ultimate name</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.globalUltimateName}</dd>
																		
																		
																		<dt>Global ultimate country</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.globalUltimateCountry}</dd>
																		
																		<dt>Registration date</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.registrationDate}</dd>
																...
																<div class="grid__col--4 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		<dt>Match name</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.matchName}</dd>
																		
																		<dt>Iso country code two digit</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.isoCountryCode2Digit}</dd>
																		
																		<dt>Iso Country Code three digit</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.isoCountryCode3Digit}</dd>
																		
																		<dt>Statement date</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.statementDate}</dd>
																		
																		<dt>Foreign owned company</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.foreignOwnedCompany}</dd>

																		<dt>Net worth</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.netWorth}</dd>

																		<dt>Fixed assets</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.fixedAssets}</dd>

																		<dt>Total liabilities and equities</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.totalLiabilitiesAndEquities}</dd>
																	
																		<dt>Total share holders</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.totalShareHolders}</dd>
																...
																<div class="grid__col--4 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		<dt>Gross income</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.grossIncome}</dd>
																		
																		<dt>Net income</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.netIncome}</dd>
																		
																		<dt>Total current assets</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.totalCurrentAssets}</dd>
																		
																		<dt>Total assets</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.totalAssets}</dd>
																		
																		<dt>Total longterm liabilities</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.totalLongTermLiabilities}</dd>
																		
																		<dt>Total current liabilities</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.totalCurrentLiabilities}</dd>
																		
																		<dt>Total matched shareholders</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.totalMatchedShareholders}</dd>
																		
																		<dt>Financial strength</dt>
																		<dd>${paymentInDetails.account.corperateCompliance.financialStrength}</dd>
															...
															<div class="grid__row">
																...
																<div class="grid__col--4">
																	<dl class="split-list">
																		...
																		<dd>${paymentInDetails.account.riskProfile.countryRiskIndicator}</dd>

																		<dt>Risk trend</dt>
																		<dd>${paymentInDetails.account.riskProfile.riskTrend}</dd>

																		<dt>Risk direction</dt>
																		<dd>${paymentInDetails.account.riskProfile.riskDirection}</dd>
																		
																		<!-- newly added fields for DNB DATA  -->
																		<dt>Continent</dt>
																		<dd>${paymentInDetails.account.riskProfile.continent}</dd>


																		<dt>Country</dt>
																		<dd>${paymentInDetails.account.riskProfile.country}</dd>


																		<dt>State country</dt>
																		<dd>${paymentInDetails.account.riskProfile.stateCountry}</dd>

																		<dt>Duns number</dt>
																		<dd>${paymentInDetails.account.riskProfile.dunsNumber}</dd>


																		<dt>Trading styles</dt>
																		<dd>${paymentInDetails.account.riskProfile.tradingStyles}</dd>


																		<dt>us1987PrimarySic4Digit</dt>
																		<dd>${paymentInDetails.account.riskProfile.us1987PrimarySic4Digit}</dd>


																		<dt>Financial figures month</dt>
																		<dd>${paymentInDetails.account.riskProfile.financialFiguresMonth}</dd>


																		<dt>Financial figures year</dt>
																		<dd>${paymentInDetails.account.riskProfile.financialFiguresYear}</dd>
																...
																<div class="grid__col--4 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		<dd>${paymentInDetails.account.riskProfile.financialYearEndDate}</dd>


																		<dt>Annual sales</dt>
																		<dd>${paymentInDetails.account.riskProfile.annualSales}</dd>


																		<dt>Modelled annual sales</dt>
																		<dd>${paymentInDetails.account.riskProfile.modelledAnnualSales}</dd>

																		<dt>Net worth amount</dt>
																		<dd>${paymentInDetails.account.riskProfile.netWorthAmount}</dd>

																		<dt>Credit limit</dt>
																		<dd>${paymentInDetails.account.riskProfile.creditLimit}</dd>
																		

															

																		<dt>Updated risk</dt>
																		<dd>${paymentInDetails.account.riskProfile.updatedRisk}</dd>

																		<dt>Failure score</dt>
																		<dd>${paymentInDetails.account.riskProfile.failureScore}</dd>

																		<dt>Delinquency failure score</dt>
																		<dd>${paymentInDetails.account.riskProfile.delinquencyFailureScore}</dd>
																		
																		<!-- newly added fields for DNB DATA  -->
																		
																		<dt>Modelled netWorth</dt>
																		<dd>${paymentInDetails.account.riskProfile.modelledNetWorth}</dd>

																		<dt>Location type</dt>
																		<dd>${paymentInDetails.account.riskProfile.locationType}</dd>

																		<dt>Import export indicator</dt>
																		<dd>${paymentInDetails.account.riskProfile.importExportIndicator}</dd>
																...
																<div class="grid__col--4 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		<dd>${paymentInDetails.account.riskProfile.domesticUltimateRecord}</dd>

																		<dt>Global ultimate record</dt>
																		<dd>${paymentInDetails.account.riskProfile.globalUltimateRecord}</dd>

																		<dt>Group structure number Of levels</dt>
																		<dd>${paymentInDetails.account.riskProfile.groupStructureNumberOfLevels}</dd>

																		<dt>Headquarter details</dt>
																		<dd>${paymentInDetails.account.riskProfile.headquarterDetails}</dd>

																		<dt>Immediate parent details</dt>
																		<dd>${paymentInDetails.account.riskProfile.immediateParentDetails}</dd>

																		<dt>Domestic Ultimate parent details</dt>
																		<dd>${paymentInDetails.account.riskProfile.domesticUltimateParentDetails}</dd>

																		<dt>Global ultimate parent details</dt>
																		<dd>${paymentInDetails.account.riskProfile.globalUltimateParentDetails}</dd>

																		<dt>Risk rating</dt>
																		<dd>${paymentInDetails.account.riskProfile.riskRating}</dd>

																		<dt>Profit loss</dt>
																		<dd>${paymentInDetails.account.riskProfile.profitLoss}</dd>
										...
										<!-- Added fraugster Check Information, fixed issue AT-474 : Abhijit G-->
										<!-- Fraugster Check BEGIN -->		
											<div class="accordion__section">
													...
													<table>
														...
														<tbody id="fraugster">
															<tr href="#" onclick="showProviderResponse('${paymentInDetails.fraugster.id}','FRAUGSTER','FraugsterChart');">
																<td hidden="hidden">${paymentInDetails.fraugster.id }</td>
																<td>${paymentInDetails.fraugster.createdOn }</td>
																<td>${paymentInDetails.fraugster.updatedBy }</td>
																<td class=""> <a href="#"
																	onclick="showProviderResponse('${paymentInDetails.fraugster.id}','FRAUGSTER')">${paymentInDetails.fraugster.fraugsterId }</a></td>	
																<%-- <td class="nowrap">${paymentInDetails.fraugster.score }</td> --%>
																<td class="nowrap">Not Required</td>
																<td class="center"><i class="material-icons">-</i></td>
																<%--<c:choose>
																		<c:when test="${paymentInDetails.fraugster.status}">
																			<td class="yes-cell"><i class="material-icons">check</i></td>
																		</c:when>
																		<c:when test="${paymentInDetails.fraugster.status eq false}">
																			<td class="no-cell"><i class="material-icons">clear</i></td>
																		</c:when>
																		<c:when test="${paymentInDetails.fraugster.status ne true}">
																			<td class="nowrap">${paymentInDetails.fraugster.status }</td>
																		</c:when>
																		<c:otherwise>
																			 <td class="nowrap">${paymentInDetails.fraugster.status }</td>
																		</c:otherwise>
																			...
																			<div class="grid__col--6">
																				...
																				<div class="form__field-wrap">
																					...
																					<div id="singlelist-document-type"
																						...
																						<p id="docTypeSelectionCfxId" class="singlelist__chosen clickpanel__trigger2">Please
																							select</p>
																							...
																							<fieldset>
																								...
																								<ul class="singlelist__options multilist__options">
																									...
																									<c:forEach var="documentList"
																										items="${paymentInDetails.documentList}"
																										varStatus="loop">
														...
														<tbody id="further_paymentOutDetails">
															<c:forEach var="payment"
																...
																<tr>
																	...
																	<td class="number">${payment.amount }</td>
																	<td class="breakword">${payment.buyCurrency }</td>
															...
															<div class="grid__row">
																...
																<div class="grid__col--6">
																	<dl class="split-list">
																		...
																		<dd id="contact_FurtherClient_email">
																			${paymentInDetails.currentContact.email}</dd>
																...
																<div class="grid__col--6 grid__col--pad-left">
																	<dl class="split-list">
																		...
																		onclick="showDeviceInfo('${paymentInDetails.account.id}')">
 ...
 --%>
								...
								<div class="grid__col--4 grid__col--pad-left p-rel">
									...
									<section id="pagepanel">
										...
										<form>
											...
											<!-- Update status section starts from here -->
												<section>
		...
		<form id="payInDetailForm" action="/compliance-portal/paymentInDetail"
			method="POST">
			...
			<ul id="paginationBlock" class="pagination--fixed page-load">
				<li class="pagination__jump--disabled"><a id="firstRecord"
					onclick="getPayInFirstRecord('${paymentInDetails.paginationDetails.firstRecord.custType}','${paymentInDetails.paginationDetails.firstRecord.id}');"
					href="#" data-ot="First record"><i class="material-icons">first_page</i></a></li>
				<li class="pagination__jump"><a id="previousRecord"
					onclick="getPayInPreviousRecord('${paymentInDetails.paginationDetails.prevRecord.custType}','${paymentInDetails.paginationDetails.prevRecord.id}');"
					href="#" data-ot="Previous record"><i class="material-icons">navigate_before</i></a>
				</li>
				<li class="pagination__jump"><a id="nextRecord"
					onclick="getPayInNextRecord('${paymentInDetails.paginationDetails.nextRecord.custType}','${paymentInDetails.paginationDetails.nextRecord.id}');"
					href="#" data-ot="Next record"><i class="material-icons">navigate_next</i></a>
				</li>
				<li class="pagination__jump"><a id="lastRecord"
					onclick="getPayInLastRecord('${paymentInDetails.paginationDetails.totalRecords.custType}','${paymentInDetails.paginationDetails.totalRecords.id}');"
	...
	<div id="drawer-user" class="drawer--closed">
		...
		<input type="hidden" id="searchCriteria"
			value='${paymentInDetails.searchCriteria}' /> <input type="hidden"
			id="contact_contactId" value='${paymentInDetails.currentContact.id}' />
		<input type="hidden" id="contact_crmAccountId"
			value='${paymentInDetails.currentContact.crmAccountId}' /> <input
			type="hidden" id="contact_crmContactId"
			value='${paymentInDetails.currentContact.crmContactId}' /> <input
			type="hidden" id="contact_accountId"
			value='${paymentInDetails.currentContact.accountId}' /> <input
			type="hidden" id="userResourceId"
			value='${paymentInDetails.userResourceId}' /> <input type="hidden"
			id="paymentinId" value='${paymentInDetails.paymentInInfo.id}' /> <input
			type="hidden" id="contact_tradeContactId"
			value='${paymentInDetails.currentContact.tradeContactID}' /> <input
			type="hidden" id="tradePaymentId"
			value='${paymentInDetails.paymentInInfo.tradePaymentId}' /> <input
			hidden="hidden" id="third_partyPayment"
	...
	<input type="hidden" id="fraugsterTotalRecordsPayInId"
		...
		<input type="hidden" id="fraugster_eventServiceLogId" 
			value='${paymentInDetails.fraugster.id}' />
	...
	<div id="AccountWhiteListDatapopups" class="popupDiv"
		...
		<!-- <div id="accountWhiteListData" class="popupTextAreaAccountHistory popup">
