 ...
 */
public class PaymentInReportAccountFilterQueryBuilder extends AbstractFilterQueryBuilder {
	 ...
	 */
	public PaymentInReportAccountFilterQueryBuilder(PaymentInFilter filter, String query, boolean addWhereCluase) {
