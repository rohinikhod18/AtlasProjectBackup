...
public class ResteasyClientHandler {
	...
	private ResteasyClientHandler() {
		...
		httpclient.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, Integer.valueOf(System.getProperty("resteasy.connection.timeout")));
		httpclient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT,Integer.valueOf(System.getProperty("resteasy.socket.timeout")));
