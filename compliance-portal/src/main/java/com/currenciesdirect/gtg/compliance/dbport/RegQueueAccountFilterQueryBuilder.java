 ...
 */
public class RegQueueAccountFilterQueryBuilder extends AbstractFilterQueryBuilder {
	 ...
	 */
	public RegQueueAccountFilterQueryBuilder(BaseFilter filter, String query, boolean addWhereCluase) {
