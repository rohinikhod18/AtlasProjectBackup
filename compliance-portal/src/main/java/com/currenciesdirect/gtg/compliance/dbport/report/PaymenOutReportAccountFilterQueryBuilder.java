 ...
 */
public class PaymenOutReportAccountFilterQueryBuilder extends AbstractFilterQueryBuilder {
	 ...
	 */
	public PaymenOutReportAccountFilterQueryBuilder(BaseFilter filter, String query, boolean addWhereCluase) {
